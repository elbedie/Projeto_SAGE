    ...
    return (
      <span
        ...
        style={{
          cursor: 'pointer',
          fontSize: "1.7em",
          color: filled ? "#ffbc00" : "#d3d3d3",
          transition: ".13s"
        }}
        title={filled ? "Selecionado" : "Não selecionado"}
      >
        <FaStar />
      </span>
    );
    ...
    <div className="agente-servico-bg">
      <form className="form-card" onSubmit={handleSubmit}>
        ...
        <div className="form-header">
          ...
          <span className="form-desc">Avaliação de serviço</span>
        </div>

        <div className="form-title">
          <FaStar className="title-icon" style={{ color: "#ffbc00" }} />
          Avaliar serviço ou funcionário
        </div>
        ...
        <div className="form-section">
          <div className="form-group">
            ...
            <div className="field">
              ...
              <textarea
                id="comentario"
                placeholder="Comentário, sugestão, elogio, etc"
                value={comentario}
