...
export default function ExternalAgentPage() {
  ...
  return (
    <div className="agente-externo-bg">
      <div className="agente-externo-box">
        <div className="logo-title">
          <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" fill="#456789" viewBox="0 0 24 24">
        ...
        <h2 className="box-title">Portal do Agente Externo</h2>
